...
<!-- Title: Contributing GithubFlow HomeAutomation -->
...
To contribute to home-automation project on [GitHub](https://github.com/luismayta/home-automation), We use [GitHub Flow](https://githubflow.github.io/), it means that you should branch from the main repository and contribute back by making [pull request](https://github.com/luismayta/home-automation/pulls).
...
To follow the instructions in this guide and start contributing to home-automation project on GitHub:
...
```bash
git remote add upstream  https://github.com/luismayta/home-automation.git
```

Now your **upstream** points to **luismayta/home-automation**.
...
git fetch upstream # assuming upstream is luismayta/home-automation
...
All merge requests are automatically tested using [Github Actions](https://github.com/luismayta/home-automation/actions). In case some tests fail, fix the issues or describe why the fix cannot be done.
